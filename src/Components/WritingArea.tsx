...
const WritingArea:React.FC<{isEditable:boolean,para:string[],setStart:(start:string|null)=>void}> = ({para,setStart,isEditable}) => {
    ...
    }, [para, currInput, setStart, insertCurrInput, deleteCurrInput, isEditable]);
